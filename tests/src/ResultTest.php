...
class ResultTest extends TestBase
{
    ...
    public function testFirst()
    {
        $result = $this->getTestResult();
        $doc = $result->first();
        $testDoc = new Document(['id' => 6, 'name' => 'Bob Jones', 'age' => 35]);
    ...
    public function testLast()
    {
        $result = $this->getTestResult();
        $doc = $result->last();
        $testDoc = new Document(['id' => 1, 'name' => 'Katie Smith', 'age' => 21]);
    ...
    public function testHash()
    {
        ...
        $this->assertSame([6 => 35, 7 => 19, 3 => 43, 9 => 37, 1 => 21], $doc);
    }

    protected function getTestResult()
    {
        return new Result([
            1 => new Document(['id' => 6, 'name' => 'Bob Jones', 'age' => 35]),
            4 => new Document(['id' => 7, 'name' => 'Fred Smith', 'age' => 19]),
            6 => new Document(['id' => 3, 'name' => 'John Appleseed', 'age' => 43]),
            7 => new Document(['id' => 9, 'name' => 'Mary Jones', 'age' => 37]),
            8 => new Document(['id' => 1, 'name' => 'Katie Smith', 'age' => 21]),
        ], 5);
    }
